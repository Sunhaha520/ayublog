      ...
      if ( $("#bber-talk").length > 0 ) {
        ...
        $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
          ...
          $.each(res.data, function(i, item){
            ...
            bberHtml += '<li class="item item-'+(i+1)+'">'+'<a href="https://www.zhenyusun.top/ayubibi/" style="color: var(--font-color);/*font-weight: normal;*/">'+newdataTime+'： '+urlToLink(item.content)+'</a></li>'
          });
